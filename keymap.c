...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, RSFT_T(KC_SLSH), KC_UP, MO(1),
	...
	LAYOUT(
		...
		KC_MUTE, KC_NO, KC_VOLD, KC_VOLU, KC_MPLY, KC_MRWD, KC_MFFD, ______, ______, ______, ______, ______, ______, ______,
